...
class RandomCropComputer(Dataset):
    ...
    def __init__(self, cfg, dataset_name, img_set, crop_type, crop_ratio):
        ...
        if crop_type == "random":
            cropper = self.random_crops
        elif crop_type == "five":
            cropper = self.five_crops
        else:
        ...
        for crop_type in crop_types:
            for dataset_name in dataset_names:
                for img_set in img_sets:
                    ...
                    loader = DataLoader(dataset, 1, shuffle=False, num_workers=cfg.num_workers, collate_fn=identity_collate)
